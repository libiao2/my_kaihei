...
import 'package:premades_nn/page/news/share_room_message_item.dart';
...
class ChatMessage extends StatefulWidget {
  ...
  final MessageItemEntity messageItem;
...
class ChatMessageState extends State<ChatMessage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget child;
    if (widget.messageItem.fromId == Constants.userInfo.nnId &&
  ...
  Widget messageBox(direction) {
    ...
    } else if (widget.messageItem.messageType == MessageType.SHARE_ROOM) {
      //分享消息
      if (widget.messageItem.content != null &&
          widget.messageItem.content != "") {
        return ShareRoomMessageItem(
            roomNo: int.parse(widget.messageItem.content));
      }
    } else {
      //文本信息
  ...
  Widget voiceCallItem(String type) {
    ...
    return InkWell(
      ...
      child: Container(
        constraints: BoxConstraints(minHeight: ScreenUtil().setHeight(42), minWidth: ScreenUtil().setWidth(42)),
        padding: padding,
