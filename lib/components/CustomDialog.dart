...
class MyDialog extends StatefulWidget {
  ...
  static void showCustomDialog(BuildContext context, MyDialog dialog) {
    showDialog(
        context: context,
    ...
    Column _columnText = Column(
      children: <Widget>[
        ...
        Text(widget.title == null ? '' : widget.title,
            style: TextStyle(fontSize: 16.0, color: Color.fromRGBO(51,51,51,1), fontWeight: FontWeight.w500)),
        Expanded(
            child: Container(
              ...
              child: Center(
                child: Text(widget.content == null ? '' : widget.content,
                    style: TextStyle(fontSize: 15.0, color: Color.fromRGBO(51,51,51,1), fontWeight: FontWeight.w500)),
              ),
            ),
            flex: 1),
